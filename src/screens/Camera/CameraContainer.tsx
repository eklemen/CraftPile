...
import { Box, Button, Center, IconButton, Spinner } from 'native-base';
...
function CameraContainer() {
  ...
  if (!cameraPermission) {
    ...
    return <MockCamera askPermissions={askPermissions} />;
  }
  ...
  return (
    <>
      <CameraHeader askGalleryPermissions={askGalleryPermissions} />
